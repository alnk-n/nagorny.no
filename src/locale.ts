...
const UI: Record<Locale, UIStrings> = {
  no: {
    ...
    readme_nav: 'For å navigere, klikk på en fil i sidemenyen, eller bruk piltastene.',
    ...
    about_hobbies: 'På fritiden skrur jeg på datautstyr, lodder, og eksperimenterer med programvare. Operativsystemer (hovedsakelig Linux) og nettverk er særlig interesserende.',
  ...
  en: {
    ...
    readme_nav: 'To navigate, click a file in the sidebar or use the arrow keys.',
    readme_mobile: 'On mobile: tap «MENU» at the top.',
    readme_built_with: 'Built with',
    readme_built_lib: 'an open-source React library.',
    readme_start_card: 'RECOMMENDED STARTING POINT',
    readme_start_text: 'Start with',

    about_bio: '17 years old, graduating IT student at Tiller VGS.',
    about_hobbies: 'In my spare time I tinker with hardware, solder, and experiment with software. Operating systems (mainly Linux) and networking are particularly interesting to me.',
    ...
    resume_edu1_text: 'Tiller VGS · IT grade 11 · IT & media production grade 10.',
    resume_edu2_period: '2021-2024',
