  ...
  return (
    <>
      ...
      <div role="tree" aria-label="filesystem">
        <TreeView title="~ / akn" defaultValue isRoot>
          <TreeView
            title="readme.md"
            isFile
            active={isActive("/")}
          ...
          <TreeView
            title="about.md"
            isFile
            active={isActive("/about.md")}
            onClick={go("/about.md")}
          />
          <TreeView
            title="now.log"
            isFile
            active={isActive("/now.log")}
            onClick={go("/now.log")}
          />
          <TreeView
            title="resume.txt"
            isFile
            active={isActive("/resume.txt")}
            onClick={go("/resume.txt")}
          />
          <TreeView
            title="contact.conf"
            isFile
            active={isActive("/contact.conf")}
            onClick={go("/contact.conf")}
          />
